            ...
            <div className="relative flex flex-col items-center pt-12">
                <div className="w-full flex flex-col items-center">
                    ...
                    >
                        ...
                        entrada a una mina. Curioso, se acerca para tratar de filmarlo cuando
                        esta atraviesa la entrada de la mina, iluminando sus paredes con un
                        fuego azulado y misterioso, y al atravesar la boca de la mina, esta se
                        derrumba iniciando, así nuestro juego...
                    </p>
                    <img
                        src={loreImage}
                        alt="Lore"
